...
void startTestsCNT2(void)
{
    ...
    if (AppID == OS_CORE_ID_MASTER_0) {
        ...
        generateTask(OS_CORE_ID_MASTER_0, 6, SUSPENDED, FULL, EXTENDED, 1, 1, 0, 5, (0U), &task1CNT2);
        generateTask(OS_CORE_ID_MASTER_0, 7, SUSPENDED, FULL, EXTENDED, 2, 2, 0, 5, (0U), &task2CNT2);
        ...
        createAlarmSoftware(3, alarmBase, 2, 0, ACTION_SETEVENT, 7, 2, 0, 0, NULL,
                            1);  
